...
return array(
    ...
    'properties' => [
        'creator'        => 'Abraham Tovar',
        'lastModifiedBy' => 'Abraham Tovar',
        'title'          => 'Frecuencias Alelicas',
        'description'    => 'Exportacion/Importacion de Excel',
        'subject'        => 'Exportacion/Importacion de Excel',
        'keywords'       => 'maatwebsite, excel, export',
        'category'       => 'Excel',
        'manager'        => 'Siscon Systems S.A. de C.V.',
        'company'        => 'Siscon Systems S.A. de C.V.',
    ],
